<nav class="navbar bg-base-100 sticky top-0 z-50 border-b border-base-content/25">
    ...
    <div class="flex flex-1 items-center">
        <a class="link text-base-content link-neutral text-xl font-semibold no-underline"
            ...
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-base-content text-xl font-bold whitespace-nowrap sr-only">{{ config('app.name') }}</h2>
            </div>
        </a>
    </div>
    ...
    <div class="navbar-end flex items-center gap-4">
        <a href="{{ route('admin.cache.clear') }}" class="btn btn-soft btn-error gap-1">
            <span class="icon-[tabler--database] size-6"></span>
            <span class="hidden md:inline-flex">Cache Clear</span>
        </a>

        {{-- View Website Button --}}
        <a href="{{ route('home') }}" target="_blank" class="btn btn-square btn-text btn-success"
            aria-label="View Website">
            <span class="icon-[tabler--world-www] size-6"></span>
        </a>
        <!-- Theme Dropdown  -->
        ...
        <div class="dropdown relative inline-flex [--offset:21]">
            ...
            <ul class="dropdown-menu dropdown-open:opacity-100 hidden w-full max-w-75 space-y-0.5" role="menu"
                ...
                <li class="dropdown-header mb-1 gap-4 px-5 pt-4.5 pb-3.5">
                    ...
                    <div>
                        <h6 class="text-base-content mb-0.5 font-semibold">{{ Auth::guard('admin')->user()->name }}
                        </h6>
                        <p class="text-base-content/80 font-medium">{{ Auth::guard('admin')->user()->email }}</p>
                    </div>
                </li>
                <li class="mb-1">
