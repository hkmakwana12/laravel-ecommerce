<x-layouts.admin>
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <x-admin.breadcrumb :links=$breadcrumbLinks title="Attributes" :addNewAction="route('admin.attributes.create')" />
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        @forelse ($attributes as $attribute)
                            <tr>
                                <td class="font-semibold">{{ $attribute->name }}</td>

                                {{-- Actions --}}
                                <td class="space-x-1 text-right">
                                    <x-admin.links.edit :href="route('admin.attributes.edit', $attribute)" />

                                    <x-admin.links.delete :action="route('admin.attributes.destroy', $attribute)" />
                                </td>
                            </tr>
                        @empty
                            <tr>
