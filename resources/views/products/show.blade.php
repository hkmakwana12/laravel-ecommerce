    ...
    <div class="bg-base-100 py-6 sm:py-10 lg:py-14">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6 space-y-4 md:mb-8 lg:mb-10">
                <h2 class="text-base-content text-2xl font-semibold md:text-3xl lg:text-4xl">Related Products</h2>
            </div>

            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                @each('components.products.card', $product->relatedProducts(4), 'product')
            </div>
        </div>
    </div>
</x-layouts.front>
